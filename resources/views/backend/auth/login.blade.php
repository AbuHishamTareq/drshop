    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="alert alert-danger" role="alert">
                <span class="fas fa-exclamation-circle mr-2"></span>{{ $message }}
            </div>
            @enderror
            @error('password')
            <div class="alert alert-danger" role="alert">
            ...
            <div class="alert alert-danger" role="alert">
                <span class="fas fa-exclamation-circle mr-2"></span>{{ Session::get('error') }}
            </div>
            @endif
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.login.submit') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-success btn-block"><span class="fas fa-unlock mr-2"></span>Login In</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
